...
read_inode_bitmap(struct super_block * sb, unsigned long block_group)
{
	...
	if (!bh)
		dedupfs_error(sb, "read_inode_bitmap",
...
{
	int parent_group = DEDUPFS_I(parent)->i_block_group;
...
unsigned long dedupfs_count_dirs (struct super_block * sb)
{
