...
#define EXT2_XATTR_LEN(name_len) \
	...
	sizeof(struct dedupfs_xattr_entry)) & ~EXT2_XATTR_ROUND)
...
extern void dedupfs_xattr_delete_inode(struct inode *);
...
static inline int
dedupfs_xattr_get(struct inode *inode, int name_index,
...
static inline void
dedupfs_xattr_delete_inode(struct inode *inode)
{
}
...
extern int dedupfs_init_security(struct inode *inode, struct inode *dir);
#else
static inline int dedupfs_init_security(struct inode *inode, struct inode *dir)
{
	return 0;
}
#endif
